...
--comment: §1.4 B.3 — manufacturing-side discontinued signal for BomService.addLine gating. Distinct from the (false, false) flags pair which can also mean "never classified".
