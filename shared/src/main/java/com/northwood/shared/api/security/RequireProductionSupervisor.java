...
/**
 * Allow only callers with the {@code production_supervisor} Keycloak realm role.
...
@PreAuthorize("hasRole('production_supervisor')")
public @interface RequireProductionSupervisor {}
