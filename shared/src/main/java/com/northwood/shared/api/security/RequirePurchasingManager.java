...
/**
 * Allow only callers with the {@code purchasing_manager} Keycloak realm role.
...
@PreAuthorize("hasRole('purchasing_manager')")
public @interface RequirePurchasingManager {}
