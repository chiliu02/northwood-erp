...
public record PurchaseRequisitionCreated(
     ...
     * consumers should reference these constants rather than literals so a
     * producer-side rename surfaces at compile time. The producer-side enum is
     * {@code PurchaseRequisition.SourceType}; same wire format, different access
     * path per the cross-service contract rule
