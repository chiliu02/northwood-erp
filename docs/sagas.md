...
- `applyInventoryCancellationApplied` returns `"compensated"` (the sole compensation ack — manufacturing's was retired) → handler calls the compensation emitter
