...
- `sales.product-discontinued` — flag the product (add `discontinued_at` to `sales.product_pricing` or a parallel `sales.product_status` projection); reject `placeOrder` lines for discontinued products.
