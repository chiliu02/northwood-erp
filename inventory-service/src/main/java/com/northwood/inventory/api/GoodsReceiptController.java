...
public class GoodsReceiptController {
    ...
    @ExceptionHandler(GoodsReceiptLineProductMismatchException.class)
    public ResponseEntity<String> handleLineProductMismatch(GoodsReceiptLineProductMismatchException e) {
