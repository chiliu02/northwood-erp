...
/**
 * In-memory double of inventory-side {@link ProductReplenishmentProjection}
 * (the §2.35 Slice A make-vs-buy snapshot inventory owns locally).
 * Defaults to empty — tests seed via {@link #put} or
 ...
 */
public final class InMemoryInventoryProductReplenishmentProjection
    implements ProductReplenishmentProjection {
    ...
    public InMemoryInventoryProductReplenishmentProjection put(UUID productId, boolean isPurchased, boolean isManufactured) {
        rows.put(productId, new Replenishment(isPurchased, isManufactured));
        return this;
    }
}
