...
class ProductDiscontinuedHandlerTest {
    ...
    @Mock AvailableToPromiseProjection projection;
    ...
    @Test void happy_path_stamps_atp_view() {
        handler.handle(event());

        verify(projection).recordProductDiscontinued(eq(PRODUCT), eq(DISCONTINUED_AT));
    ...
    @Test void already_processed_short_circuits() {
        ...
        verify(projection, never()).recordProductDiscontinued(any(), any());
