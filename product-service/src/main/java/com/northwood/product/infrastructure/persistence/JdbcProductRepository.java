    ...
    private RowMapper<Product> rowMapper(Map<UUID, List<ApprovedVendor>> vendorsByProduct) {
        return (rs, n) -> {
            ...
            return Product.reconstitute(
                ...
                ProductType.fromCode(rs.getString("product_type")),
                ...
                replenishmentStrategyDb == null ? null : ReplenishmentStrategy.fromCode(replenishmentStrategyDb),
                valuationClassDb == null ? null : ValuationClass.fromCode(valuationClassDb),
                rs.getObject("active_bom_id", UUID.class),
                rs.getInt("planning_time_fence_days"),
                Product.Status.fromCode(rs.getString("status")),
                rs.getLong("version"),
