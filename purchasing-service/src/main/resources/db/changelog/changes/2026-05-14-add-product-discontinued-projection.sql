...
CREATE TABLE IF NOT EXISTS purchasing.product_discontinued (
    product_id      UUID PRIMARY KEY,
    discontinued_at TIMESTAMPTZ NOT NULL
);
--rollback DROP TABLE IF EXISTS purchasing.product_discontinued;
