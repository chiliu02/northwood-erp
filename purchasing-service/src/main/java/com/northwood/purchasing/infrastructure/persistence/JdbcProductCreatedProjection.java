...
public class JdbcProductCreatedProjection implements ProductCreatedProjection {
    ...
    @Override
    @Transactional
    public void applyCreated(UUID productId, String productSku, String productName) {
        jdbc.update("""
            INSERT INTO purchasing.product_card (product_id, product_sku, product_name)
            VALUES (?, ?, ?)
        ...
        log.info("upserted purchasing.product_card name snapshot for product_id={} (sku={})",
