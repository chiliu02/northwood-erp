...
/**
 * Command for posting a single physical payment that settles multiple
 * supplier invoices from the same supplier.
 */
public record RecordSupplierPaymentMultiCommand(
    ...
    public record InvoiceLine(
        @NotNull UUID supplierInvoiceHeaderId,
